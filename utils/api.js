...
class InjectMagicAPI {
  ...
  async getNyxResponses() {
    const response = await fetch(
      "https://api.injectmagic.com/sisyphus/nyx-responses/",
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Token ${this.apiKey}`,
  ...
  async postNyxResponse(response, wake) {
    return this.post("nyx-responses/", { response, wake });
  }

  async getNyxChapters() {
    const response = await fetch(
      "https://api.injectmagic.com/sisyphus/nyx-chapters/",
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Token ${this.apiKey}`,
  ...
  async postNyxChapter(chapter) {
    return this.post("nyx-chapters/", { chapter });
  }
